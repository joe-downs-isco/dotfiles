...
# tar archive, and moves it to another directory ($DEST) to be copied elsewhere
# by another script. These two given values are passed along as the first and
...
do
    ...
    mv PART.$output.tar $DEST$output.tar
    rm -rf $output
done
